# Import blocks go here when resources already exist in Azure.
# On a fresh deployment this file should be empty.

# import {
#   to = azurerm_key_vault_secret.cosmos_mongo_connstr
#   id = "https://kv-trezure.vault.azure.net/secrets/porter-db-connection-string/608977b7922c4bb68520158c14484c29"
# }
...
#   id = "https://kv-trezure.vault.azure.net/secrets/api-client-secret/9ac19815160f4fd19a16ff74dbe35ee5"
# }
...
#   id = "https://kv-trezure.vault.azure.net/secrets/application-admin-client-secret/fcfc83804f3d46c7bcba86ea6b1416eb"
# }
...
# import {
#   to = module.azure_monitor.azurerm_log_analytics_linked_storage_account.workspace_storage_ingestion
#   id = "/subscriptions/91607e02-215d-4dc0-b0e1-01554294ae00/resourceGroups/rg-trezure/providers/Microsoft.OperationalInsights/workspaces/log-trezure/linkedStorageAccounts/Ingestion"
# }

# import {
#   to = module.azure_monitor.azurerm_log_analytics_linked_storage_account.workspace_storage_customlogs
#   id = "/subscriptions/91607e02-215d-4dc0-b0e1-01554294ae00/resourceGroups/rg-trezure/providers/Microsoft.OperationalInsights/workspaces/log-trezure/linkedStorageAccounts/CustomLogs"
# }
...
#   id = "https://kv-trezure.vault.azure.net/secrets/resource-processor-vmss-password/538007c9b26b4587a87d3e64b180e888"
# }
...
# import {
#   to = module.firewall.azurerm_public_ip.fwtransit[0]
#   id = "/subscriptions/91607e02-215d-4dc0-b0e1-01554294ae00/resourceGroups/rg-trezure/providers/Microsoft.Network/publicIPAddresses/pip-fw-trezure"
# }
